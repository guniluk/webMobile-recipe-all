      ...
      <div className="relative w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl flex flex-col items-center">
        <div className="mb-6 text-center">
          ...
          <p className="text-slate-400 text-sm mt-2">
            Sign in to search and save your favorite recipes
          </p>
        </div>
        <ClerkSignIn
          signUpUrl="/sign-up"
          appearance={{
            elements: {
              ...
              socialButtonsBlockButton:
                "bg-white/10 hover:bg-white/20 border-white/10 text-white font-medium",
              socialButtonsBlockButtonText: "text-white",
              formButtonPrimary:
                "bg-indigo-600 hover:bg-indigo-700 text-white font-semibold transition-colors rounded-xl py-3",
              formFieldInput:
                "bg-white/5 border-white/10 text-white rounded-xl focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500",
