...
export default function Favorites() {
  const { user } = useUser();
  const { favorites, loading, fetchFavorites, removeFavorite } =
    useFavoriteStore();
        ...
        {!loading && favorites.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            ...
            <div className="relative group bg-slate-900 rounded-3xl border border-slate-800 p-6 shadow-md overflow-hidden">
              <div className="absolute inset-0 bg-linear-to-r from-rose-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            {/* Stat Item 2 */}
            <div className="relative group bg-slate-900 rounded-3xl border border-slate-800 p-6 shadow-md overflow-hidden">
              <div className="absolute inset-0 bg-linear-to-r from-amber-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="flex items-center space-x-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 px-4 bg-slate-900/40 rounded-3xl border border-slate-800/80 max-w-xl mx-auto mt-8 flex flex-col items-center">
            ...
            <p className="text-slate-400 text-sm max-w-xs mb-8">
              Explore our recipes, cook tasty meals, and save your favorites
              here.
            </p>
            <Link
              to="/"
